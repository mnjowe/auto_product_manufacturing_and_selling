...
if(isset($_POST['create_material'])){
  ...
  if($lastInsertId){
    $in_stock = 1;
    $sql = "INSERT INTO `tbl_stock_material`(material_name, material_category, material_supplier, in_stock) VALUES(:lastInsertId, :material_category, :material_supplier, :in_stock)";
    $query = $dbconn->prepare($sql);
